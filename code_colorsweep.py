...
apple_sprites, apple_sprites_palette = adafruit_imageload.load("apple_spritesheet_lined_6_indexed.bmp")
print(f"free: {gc.mem_free()}")
# apple_sprites_palette.make_transparent(0)
color_sweep(0xffffff, apple_sprites_palette)

f_sprites, f_sprites_palette = adafruit_imageload.load("f_spritesheet_lined_6_indexed.bmp")
color_sweep(0xffffff, f_sprites_palette)
# f_sprites_palette.make_transparent(0)
r_sprites, r_sprites_palette = adafruit_imageload.load("r_spritesheet_lined_6_indexed.bmp")
color_sweep(0xffffff, r_sprites_palette)
# r_sprites_palette.make_transparent(0)
u_sprites, u_sprites_palette = adafruit_imageload.load("u_spritesheet_lined_6_indexed.bmp")
color_sweep(0xffffff, u_sprites_palette)
# u_sprites_palette.make_transparent(0)
i_sprites, i_sprites_palette = adafruit_imageload.load("i_spritesheet_lined_6_indexed.bmp")
color_sweep(0xffffff, i_sprites_palette)
# i_sprites_palette.make_transparent(0)
t_sprites, t_sprites_palette = adafruit_imageload.load("t_spritesheet_lined_6_indexed.bmp")
color_sweep(0xffffff, t_sprites_palette)
# t_sprites_palette.make_transparent(0)
j_sprites, j_sprites_palette = adafruit_imageload.load("j_spritesheet_lined_6_indexed.bmp")
j_sprites_palette.make_transparent(0)
color_sweep(0xffffff, j_sprites_palette, start_at_index=2)
a_sprites, a_sprites_palette = adafruit_imageload.load("a_spritesheet_lined_6_indexed.bmp")
a_sprites_palette.make_transparent(0)
color_sweep(0xffffff, a_sprites_palette, start_at_index=2)
m_sprites, m_sprites_palette = adafruit_imageload.load("m_spritesheet_lined_6_indexed.bmp")
